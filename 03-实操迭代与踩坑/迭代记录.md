...
## 2026-07-25 · AI Hero 最终文件复验、二次返修与封面
...
- adopted:
  ...
  - 封面保留人物身份参考、完整 prompt 与错误稿修订链；中文错字通过重新生成修复。
  - 用户否决首轮封面后，将“真人身份与摄影纹理”提升为封面硬门槛：优先保留原始人物像素，生成只负责背景、光影、单一主道具和排版。
  - 用用户提供的成熟博主封面反推制作顺序：真人底片 / 抠图先行，随后统一光向、颗粒和景深，最后加入实体化概念道具与 3D 标题。
- rejected_or_deferred:
  - 不恢复“单行 + 约 19 字自动硬切”。
...
- new_canaries:
  ...
  - `cover-chinese-duplicate-character`
...
- verification:
  ...
  - 首轮 16:9 与 4:3 封面被用户否决，已作为反例保留；第二轮改用身份锁定、自然皮肤纹理、暗棚拍背景和单一主道具，重新生成并核对中文标题、比例与人物识别度；
